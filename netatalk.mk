...
$(PKG)_BINS_AFPD := hash
$(PKG)_BINS_AFPD_BUILD_DIR := $(NETATALK_BINS_AFPD:%=$($(PKG)_DIR)/etc/afpd/%)
$(PKG)_BINS_AFPD_TARGET_DIR := $(NETATALK_BINS_AFPD:%=$($(PKG)_DEST_DIR)/usr/bin/%)

$(PKG)_BINS_CNID_METAD := dbd
$(PKG)_BINS_CNID_METAD_BUILD_DIR := $(NETATALK_BINS_CNID_METAD:%=$($(PKG)_DIR)/etc/cnid_metad/%)
$(PKG)_BINS_CNID_METAD_TARGET_DIR := $(NETATALK_BINS_CNID_METAD:%=$($(PKG)_DEST_DIR)/usr/bin/%)

$(PKG)_BINS := $(NETATALK_BINS_AFPD) $(NETATALK_BINS_CNID_METAD)
$(PKG)_BINS_BUILD_DIR := $(NETATALK_BINS_AFPD_BUILD_DIR) $(NETATALK_BINS_CNID_METAD_BUILD_DIR)
$(PKG)_BINS_TARGET_DIR := $(NETATALK_BINS_AFPD_TARGET_DIR) $(NETATALK_BINS_CNID_METAD_TARGET_DIR)

$(PKG)_SBINS_AFPD := afpd
$(PKG)_SBINS_AFPD_BUILD_DIR := $(NETATALK_SBINS_AFPD:%=$($(PKG)_DIR)/etc/afpd/%)
$(PKG)_SBINS_AFPD_TARGET_DIR := $(NETATALK_SBINS_AFPD:%=$($(PKG)_DEST_DIR)/sbin/%)

$(PKG)_SBINS_CNID_METAD := cnid_metad cnid_dbd
$(PKG)_SBINS_CNID_METAD_BUILD_DIR := $(NETATALK_SBINS_CNID_METAD:%=$($(PKG)_DIR)/etc/cnid_metad/%)
$(PKG)_SBINS_CNID_METAD_TARGET_DIR := $(NETATALK_SBINS_CNID_METAD:%=$($(PKG)_DEST_DIR)/sbin/%)

$(PKG)_SBINS := $(NETATALK_SBINS_AFPD) $(NETATALK_SBINS_CNID_METAD)
$(PKG)_SBINS_BUILD_DIR := $(NETATALK_SBINS_AFPD_BUILD_DIR) $(NETATALK_SBINS_CNID_METAD_BUILD_DIR)
$(PKG)_SBINS_TARGET_DIR := $(NETATALK_SBINS_AFPD_TARGET_DIR) $(NETATALK_SBINS_CNID_METAD_TARGET_DIR)
