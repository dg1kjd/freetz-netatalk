...
Als Gast können Volumes gemountet werden, die Authentifizierung mit DHX2 funktioniert noch nicht. Ausserdem funktioniert das Logging von afpd nicht, das kann aber auch ein Bug upstream sein. Auf jeden Fall macht es die Arbeit nicht einfacher.
